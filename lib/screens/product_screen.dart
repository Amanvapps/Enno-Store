  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
          ...
          elevation: 2,
          title: Center(child: Text('Enno Store' , style: TextStyle(color: Colors.white),)),
          actions : <Widget>[
            GestureDetector(
                onTap: (){
            ...
            Row(
              ...
              children: [
                Container(
                  ...
                  child: Text(
                    productItem.prod_name, style: TextStyle(fontSize: 15 , fontWeight: FontWeight.bold , color: Colors.black),),
                ),
                GestureDetector(
                  onTap: () async {
